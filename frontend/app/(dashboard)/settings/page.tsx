export default function SettingsPage() {
  return (
    <div className="p-8 h-full flex flex-col">
      <div>
        <h1 className="text-3xl font-poppins font-bold text-slate-800">System Settings</h1>
        <p className="text-slate-500 font-inter mt-1">
          Atur preferensi akun, notifikasi, dan konfigurasi aplikasi.
        </p>
      </div>
      ...
      <div className="mt-8 flex-1 flex items-center justify-center border-2 border-dashed border-slate-200 rounded-2xl bg-white/50">
        <div className="text-center">
          ...
          <p className="text-sm text-slate-500 mt-1">Konfigurasi sistem akan segera tersedia.</p>
        </div>
      </div>
    </div>
  );
